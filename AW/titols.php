<html>
		  ...
		  <nav class="navbar navbar-default">
			<div class="container-fluid">
			  <div class="navbar-header">
				...
				<a class="navbar-brand" href="http://xampp/AW/index.php">Base de dades Futbol</a>
			  </div>
				...
				<ul class="nav navbar-nav">
				  ...
				  <li class="dropdown, active">
					...
					<ul class="dropdown-menu">
					  ...
					  <li class="active"><a href="titols.php">Mostrar títols</a></li>
					</ul>
				  </li>
				</ul>
			  </div><!--/.nav-collapse -->
	...
	<?php
		...
		$sql2="SELECT nom, codiequip FROM titols";
		
		$result=$conn->query($sql);
		$result2=$conn->query($sql2);
		
		echo "<table class=\"table table-striped table-bordered table-hover\">";
		echo "<tr><th>Equip</th><th>Escut</th><th>Títols</th></tr>";
