	 ...
	 <body>
		...
		<div class="container">
		  ...
		  <div class="jumbotron">
			  <div class="container">
				...
				<p class="lead">De: José María Samos Diago</p>
						<form name="formulari3" method="get" action="modify.php">
							Codi del equip a modificar: <input type="text" name="codi" value="">
							<br>
							Nom: <input class="form-control" type="text" name="nom" value="">
							Localitat: <input class="form-control" type="text" name="localitat" value="">
							Pàgina web: <input class="form-control" type="text" name="web" value="">
							Escut: <input class="form-control" type="text" name="escut" value="">
							<br>
		  ...
		  <?php
			...
			echo "<tr><th>Codi</th><th>Equip</th><th>Localitat</th><th>Pàgina Web</th><th>Escut</th></tr>";
			if ($result->num_rows > 0){
				while($row=$result->fetch_assoc()){
					echo "<tr><td>".$row["codi"]."</td><td>".$row["nom"]."</td><td>".$row["localitat"]."</td>";
					if ($row["web"]!=NULL){
